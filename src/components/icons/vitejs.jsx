const ViteJS = ({ width = 50, height = 50 }) => {
  return (
    <svg
      ...
      viewBox="0 0 128 128"
      role="img"
      aria-labelledby="viteJSTitle"
      focusable="false"
    >
      <title id="viteJSTitle">ViteJS</title>
      <defs>
        <linearGradient id="vite-gradient-a" x1="6" x2="235" y1="33" y2="344" gradientTransform="translate(0 .937) scale(.3122)" gradientUnits="userSpaceOnUse">
          <stop offset="0" stopColor="#41d1ff"></stop>
          <stop offset="1" stopColor="#bd34fe"></stop>
        </linearGradient>
        <linearGradient id="vite-gradient-b" x1="194.651" x2="236.076" y1="8.818" y2="292.989" gradientTransform="translate(0 .937) scale(.3122)" gradientUnits="userSpaceOnUse">
